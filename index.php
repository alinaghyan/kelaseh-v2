                               ...
                               <div class="accordion-body p-2">
                                  <div class="row g-2">
                                     ...
                                     <div class="col-6 col-md-2">
                                        <label class="form-label form-label-sm">ساعت جلسه</label>
                                        <input name="sessions[<?php echo $s['id']; ?>][time]" type="text" inputmode="numeric" maxlength="5" pattern="([01][0-9]|2[0-3]):[0-5][0-9]" class="form-control form-control-sm" placeholder="مثلا 16:20" dir="ltr" />
                                     </div>
                                     <div class="col-6 col-md-2">
                                        <label class="form-label form-label-sm">شماره اتاق</label>
                                        <input name="sessions[<?php echo $s['id']; ?>][room]" type="text" inputmode="numeric" maxlength="3" pattern="[0-9]{1,3}" class="form-control form-control-sm" placeholder="مثلا 101" />
                                     </div>
            ...
            <div class="card-body">
                    ...
                    <form id="formKelasehCreate">
                      <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="form-text small">در صورت خالی بودن، تاریخ امروز درج می‌شود و ظرفیت روزانه به صورت خودکار اعمال می‌گردد. اگر تاریخ را دستی انتخاب کنید، محدودیت ظرفیت روزانه برای ثبت کلاسه اعمال نمی‌شود. برای حذف تاریخ انتخاب‌شده دکمه «×» را بزنید.</div>
                        </div>
                        <div class="col-12">
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="kelasehIsResolution" name="is_resolution">
                            <label class="form-check-label" for="kelasehIsResolution">حل اختلاف (در صورت عدم انتخاب: هیات تشخیص)</label>
                          </div>
                        </div>
                ...
                <div class="card mt-3">
                  <div class="card-header small py-1 bg-light d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <div class="d-flex flex-wrap gap-2 align-items-center action-bar">
                      ...
                      <button id="btnKelasehTodayMarkResolution" class="btn btn-outline-success btn-sm d-none admin-only-bulk-authority" type="button">تبدیل انتخابی به حل اختلاف</button>
                      <button id="btnKelasehTodayMarkTashkhis" class="btn btn-outline-secondary btn-sm d-none admin-only-bulk-authority" type="button">تبدیل انتخابی به هیات تشخیص</button>
              ...
              <div class="kelaseh-sticky-controls">
                <div class="row g-2 mb-2 kelaseh-filters-row">
                  ...
                  <div class="col-6 col-md-2">
                    <div class="input-group input-group-sm">
                      <span class="input-group-text">مرجع</span>
                      <select id="kelasehAuthorityFilter" class="form-select">
                        <option value="">همه</option>
                        <option value="tashkhis">هیات تشخیص</option>
                        <option value="resolution">حل اختلاف</option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="d-flex flex-wrap gap-2 mb-2 align-items-center action-bar">
                  ...
                  <button id="btnKelasehMarkResolution" class="btn btn-outline-success btn-sm d-none admin-only-bulk-authority" type="button">تبدیل انتخابی به حل اختلاف</button>
                  <button id="btnKelasehMarkTashkhis" class="btn btn-outline-secondary btn-sm d-none admin-only-bulk-authority" type="button">تبدیل انتخابی به هیات تشخیص</button>
              ...
              <div class="d-flex flex-wrap gap-2 mt-2 mb-3 align-items-center action-bar">
               ...
               <!-- <button id="btnKelasehPrintLabelsBottomNew" class="btn btn-outline-secondary btn-sm" type="button" disabled>چاپ لیبل جدید (انتخاب‌ها)</button> -->
                ...
                <button id="btnKelasehMarkResolutionBottom" class="btn btn-outline-success btn-sm d-none admin-only-bulk-authority" type="button">حل اختلاف (انتخاب‌ها)</button>
                <button id="btnKelasehMarkTashkhisBottom" class="btn btn-outline-secondary btn-sm d-none admin-only-bulk-authority" type="button">هیات تشخیص (انتخاب‌ها)</button>
